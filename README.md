...
**SELECTION**<br>
A maximum of **20** candidates will be selected based on their need for the course as emerging from the application form. Chosen participants will be notified by **6th November 2020**. Priority will be given to candidates from ELIXIR-IIB member institutes (see the list at the bottom) and ELIXIR Nodes.<br>
...
### Contact
For all kinds of queries, please contact Gianluca Della Vedova at: <flavia.villani@igb.cnr.it> <simon.heumos@qbic.uni-tuebingen.de>.
<br>
<br>
